...
## raw/decisions/
- [2026-08-23-office-rebuild-plan.md](../raw/decisions/2026-08-23-office-rebuild-plan.md) — Divinum Officium cleared as a source (MIT, in the README not a LICENSE file), the Office rebuilt with real daily propers, a `traditional` / `modern` rite toggle, build sequence, and the pre-Advent target. _(2026-08-24)_
