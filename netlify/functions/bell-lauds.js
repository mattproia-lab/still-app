// netlify/functions/bell-lauds.js
//
// STUB. Bell delivery is client-side now.
//
// This used to POST Lauds to OneSignal on an hourly cron, filtering users
...
// together with its [functions.bell-lauds] block.
...
exports.handler = async () => ({
  ...
  body: JSON.stringify({
    ...
    note: 'Lauds bells are scheduled on-device by bell-native.js via @capacitor/local-notifications. This endpoint no longer sends anything.'
  })
});
